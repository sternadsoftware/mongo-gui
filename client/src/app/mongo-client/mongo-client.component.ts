...
@Component({
  selector: 'app-mongo-client',
  templateUrl: './mongo-client.component.html',
  styleUrls: ['./mongo-client.component.css']
})
export class MongoClientComponent implements OnInit {
